...
namespace CrudOperation.Services.Repository
{
    public sealed class StudentRepository : IStudent
    {
        ...
        //    {
        //        new Student { Id = 1, FirstName = "Ajit", LastName = "Verma", Age = 24, Gender = "Male", Address = "Kurla", Class = "BScIT" },
        //        new Student { Id = 2, FirstName = "Rajesh", LastName = "Sharma", Age = 22, Gender = "Male", Address = "Ghatkopar", Class = "BScIT" }
        //    };
        //}
